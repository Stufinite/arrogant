    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('公司規模', models.CharField(default='', max_length=5)),
                ('地址', models.CharField(default='', max_length=40)),
                ('資本額', models.CharField(default='', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('salary', models.CharField(default='', max_length=30)),
                ('path', models.CharField(default='', max_length=40)),
        ...
        migrations.AddField(
            model_name='comment',
            name='author',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cmtauthor', to='infernoWeb.User'),
        ),
        migrations.AddField(
            model_name='category',
            name='Job',
